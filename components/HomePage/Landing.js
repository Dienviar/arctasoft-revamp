...
const Landing = () => {
  return (
    <section className='flex items-center justify-center w-full h-auto screen420px:mt-20'>
        <div className='w-[1100px] h-[500px] flex justify-center px-5 mt-16 screen1020px:grid screen1020px:h-auto screen1020px:mt-0'>
            ...
            <article className='relative flex justify-center w-full h-[500px] items-center'>
                <Orbit/>
            </article>
        </div>
    </section>
